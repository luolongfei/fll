...
<head>
    ...
    <style type="text/css">
        .vue-version[data-v-7f0a5fab] {
            text-align: center;
            font-size: 12px;
            color: #ccc;
        }

        .center[data-v-7f0a5fab] {
            margin-top: 15px;
            text-align: center;
        }

        .vux-notice[data-v-7f0a5fab] {
            color: #666;
            line-height: 40px;
        }

        .demo-icon[data-v-7f0a5fab] {
            margin-right: 15px;
        }

        .vux-title[data-v-7f0a5fab] {
        ...
        body[data-v-7f0a5fab] {
            font-family: Helvetica, sans-serif;
            background-color: #fbf9fe;
        }

        .demo-tip[data-v-7f0a5fab] {
    ...
    <style type="text/css">
        .cbox[data-v-372daa4f] {
            text-align: center;
        }

        .cbox-inner[data-v-372daa4f] {
            padding: 15px 0;
            width: 100%;
            height: 100%;
        }

        .demo-list-box[data-v-372daa4f] {
            margin-bottom: 10px;
